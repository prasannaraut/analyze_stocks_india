# This is a sample script which shows how to filter stocks using optionChain data available on nseWebsite
...
from analyze_stocks_india.get_stock_moment_from_optionChain import get_stock_using_optionChain
...
buy_signals = get_stock_using_optionChain(nifty_50)
